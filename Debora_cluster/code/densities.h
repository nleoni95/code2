...
void WriteVector(std::vector<DATA> const &v, std::string const &filename);
...
void WriteVectors(std::vector<Eigen::VectorXd> const &v1, std::vector<double> const &v2, std::string const &filename);
void WriteVectors(std::vector<Eigen::VectorXd> const &v1, std::vector<Eigen::VectorXd> const &v2,std::vector<double> const &v3, std::string const &filename);
void OptimizeGPBis(GP & gp, Eigen::VectorXd &guess, Eigen::VectorXd const & lb,Eigen::VectorXd const & ub, double time);
...
public:
    ...
    std::vector<std::vector<Eigen::VectorXd>> SampleHparsOpt(std::vector<Eigen::VectorXd> const &thetas, int nsamples,std::default_random_engine & generator) const;
    ...
    double (*Kernel_GP)(Eigen::VectorXd const &, Eigen::VectorXd const &, Eigen::VectorXd const &),double (*DKernel_GP)(Eigen::VectorXd const &, Eigen::VectorXd const &, Eigen::VectorXd const &,int));

    void OptimizeHGPs(Eigen::MatrixXd Bounds_hpars_GPs, std::vector<Eigen::VectorXd> Hpars_guess_GPs,double ftol,Eigen::VectorXi &count);
