...
class DensityOpt : public Density{
    ...
    void update_hGPs(std::vector<Eigen::VectorXd> const &new_thetas,double (*Kernel_GP)(Eigen::VectorXd const &, Eigen::VectorXd const &, Eigen::VectorXd const &),Eigen::MatrixXd const & Bounds_hpars_GPs,Eigen::VectorXd const & Hpars_guess_GPs,int nmodes);
...
class Densities{
    ...
    int optroutine(nlopt::vfunc optfunc,void *data_ptr, std::vector<double> &x, std::vector<double> const & lb_hpars, std::vector<double> const & ub_hpars);
    ...
    std::vector<Eigen::VectorXd> HparsKOH_separate(std::vector<Eigen::VectorXd> const & hpars_guess_vec);
    std::vector<Eigen::VectorXd> HparsKOH_pooled(std::vector<Eigen::VectorXd> const & hpars_guess_vec);
