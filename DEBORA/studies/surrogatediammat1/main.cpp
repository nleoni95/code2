...
int main(int argc, char **argv){
  ...
  MainDensity.Autocor_diagnosis(nautocor,"results/diag/autocorkohmat1.gnu");
  MainDensity.WriteMCMCSamples("results/diag/allsampkohmat1.gnu");
  MainDensity.WriteSamples("results/diag/sampkohmat1.gnu");
  auto mcmc_koh=chrono::steady_clock::now();

  //MainDensity.ReadSamples("results/save/sampkohdiammat.gnu");
  MainDensity.WritePredictionsF(VectorXd::Random(1),"results/preds/diamkohmat1F.gnu");
  MainDensity.WritePredictions(VectorXd::Random(1),"results/preds/diamkohmat1.gnu");
  MainDensity.WritePriorPredictionsF(VectorXd::Random(1),"results/preds/diampriormat1F.gnu",generator);
  ...
  MainDensity.WritePredictionsF(VectorXd::Random(1),"results/preds/diamnoedmmat1F.gnu");
  MainDensity.WritePredictions(VectorXd::Random(1),"results/preds/diamnoedmmat1.gnu");
  MainDensity.WriteSamples("results/save/samplesnoedmdiammat1.gnu");
  MainDensity.Autocor_diagnosis(nautocor,"results/diag/autocornoedmmat1.gnu");
  MainDensity.WriteMCMCSamples("results/diag/allsampnoedmmat1.gnu");
  ...
  MainDensity.WritePredictionsF(VectorXd::Random(1),"results/preds/diamfullbayesmat1F.gnu");
  MainDensity.WritePredictions(VectorXd::Random(1),"results/preds/diamfullbayesmat1.gnu");
  MainDensity.WriteSamples("results/save/samplesfullbayesdiammat1.gnu");
  MainDensity.Autocor_diagnosis(nautocor,"results/diag/autocorfullbayesmat1.gnu");
  MainDensity.WriteMCMCSamples("results/diag/allsampfullbayesmat1.gnu");
  */
  ...
  DensOpt.WritehGPs("results/save/hGPsdiammat1.gnu");
  ...
  DensOpt.Autocor_diagnosis(nautocor,"results/diag/autocoroptmat1.gnu");
  DensOpt.WriteMCMCSamples("results/diag/allsampoptmat1.gnu");

  //DensOpt.ReadSamples("results/save/sampoptdiammat.gnu");

  DensOpt.WritePredictionsF(VectorXd::Random(1),"results/preds/diamoptmat1F.gnu");
  DensOpt.WritePredictions(VectorXd::Random(1),"results/preds/diamoptmat1.gnu");

  auto pred_opt=chrono::steady_clock::now();

  DensOpt.WriteSamples("results/save/sampoptdiammat1.gnu");
