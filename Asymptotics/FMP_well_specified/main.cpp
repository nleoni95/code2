...
int main(int argc, char **argv)
{
  ...
  double noise = 5e-2; //sigma noise. 0.05 pour results gold hparsoptmoinsun.
  int nombre_steps_mcmc = 10000;
...
/*
  ...
  //string fnamed = "results/hoptmoinsun.gnu";
