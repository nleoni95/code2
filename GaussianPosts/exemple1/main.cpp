...
int main(int argc, char **argv){
  ...
  auto run_analysis=[](string foldname,int nobs,int seed){
    ...
    VectorXd lb_hpars(dim_hpars); lb_hpars(0)=1e-5;
    VectorXd ub_hpars(dim_hpars); ub_hpars(0)=1;
  ...
  list<int> lseeds={42,654,332,465,221,488,684,2163,4684,354,4486,21684,254,6843};
  double tmean=0;
  double tstd=0;
  double smean=0;
  double sstd=0;
