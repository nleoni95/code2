...
public:
    ...
    void SetFixedInputerr(double logstdinputerr, Eigen::VectorXd true_derivatives_at_obs);
    void SetLearnedInputerr(int index, Eigen::VectorXd true_derivatives_at_obs);
