...
def exp_datab():
    #renvoie les données expérimentales du cas chosen_case.
    casestr=str(chosen_case)
    kennel=np.loadtxt('/home/nl255551/Bureau/articles_ravik/courbes_ravik/Kennel'+casestr+'.csv',delimiter=",")
...
# print(caselol)                   #
# print(chosen_case)               #
# print(run_model(14,ParamsRavik)) #
####################################
