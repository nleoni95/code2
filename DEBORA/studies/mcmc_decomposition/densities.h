...
class Density
{
    ...
    int optroutine_withgrad(nlopt::vfunc optfunc,void *data_ptr, Eigen::VectorXd &x, Eigen::VectorXd const & lb_hpars, Eigen::VectorXd const & ub_hpars,nlopt::algorithm alg);
...
class DensityOpt : public Density{
    ...
    Eigen::VectorXd HparsOpt(Eigen::VectorXd const & theta, Eigen::VectorXd const & hpars_guess,nlopt::algorithm alg);
