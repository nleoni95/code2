...
int main(int argc, char **argv){
...

  {
    ...
    lb_hpars_diam << 2e-5,1e-8,5e-4,-3e-4; 
    ub_hpars_diam << 5e-3,3e-5,1e-1,3e-4;
    ...
    //phase KOH. ne marche aps car on a prior mean.
  /*
    {
...
exit(0);
     ...
     /// phase full bayes. ne marche pas car prior mean.
