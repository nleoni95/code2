...
class Density
{
    ...
    void Run_MCMC_fixed_hpars(int nsteps,int nsamples, Eigen::MatrixXd const & COV_init,Eigen::VectorXd const & hpars,std::default_random_engine & generator);
    ...
    double Run_Burn_phase_FullMCMC_Controlled(int nburn, Eigen::MatrixXd & COV_init,Eigen::VectorXd &Xcurrent,std::default_random_engine & generator);
    void Run_FullMCMC(int nsteps,int nsamples, Eigen::MatrixXd const & COV_init,std::default_random_engine & generator);
    void Run_FullMCMCWithScale(int nsteps,int nsamples, Eigen::MatrixXd const & COV_init,std::default_random_engine & generator);
    ...
    Eigen::MatrixXd scale_covmatrix(Eigen::MatrixXd const & COV, Eigen::VectorXd const & Xcurrent, std::function<double(Eigen::VectorXd)> const & compute_score, double true_accrate, std::default_random_engine & generator) const;
    ...
    //diagnostic MCMC
    Eigen::VectorXd Lagged_mean(int n) const;
    void Autocor_diagnosis(int nstepsmax, std::string const & filename);
...
class DensityOpt : public Density{
    ...
    void Initialise_GPs(double (*Kernel_GP)(Eigen::VectorXd const &, Eigen::VectorXd const &, Eigen::VectorXd const &),Eigen::MatrixXd const & Bounds_hpars_GPs,Eigen::VectorXd const & Hpars_guess_GPs);
    void Test_hGPs(std::default_random_engine & generator) ;
    ...
    //Fonctions de MCMC
    double Run_Burn_phase_MCMC_opti(int nburn, Eigen::MatrixXd & COV_init,Eigen::VectorXd &Xcurrent,std::default_random_engine & generator);
    void Run_MCMC_opti(int nsteps,int nsamples, Eigen::MatrixXd const & COV_init,std::default_random_engine & generator);
    ...
    std::function<double(Eigen::VectorXd const &,Eigen::VectorXd const &,Eigen::VectorXd const &)> m_Kernel_GP_hpars; //un même noyau pour tous les GPs.
    Eigen::MatrixXd m_Bounds_hpars_GPs; //des mêmes bornes d'optimisation pour tous les GPs.
    std::vector<double> m_hpars_opt_means;
    std::vector<double> m_hpars_opt_stds;
