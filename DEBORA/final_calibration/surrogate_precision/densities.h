...
class DensityOpt : public Density{
    ...
    //Fonctions de MCMC
    /*
    double Run_Burn_phase_MCMC_opti_modified(int nburn, Eigen::MatrixXd & COV_init,Eigen::VectorXd &Xcurrent,std::default_random_engine & generator,Eigen::VectorXd const &step_hessian);
    void Run_MCMC_opti_modified(int nsteps,int nsamples, Eigen::MatrixXd const & COV_init,std::default_random_engine & generator,Eigen::VectorXd const &step_hessian);
    */
    double Run_Burn_phase_MCMC_opti_classical(int nburn, Eigen::MatrixXd & COV_init,Eigen::VectorXd &Xcurrent,std::default_random_engine & generator);
    void Run_MCMC_opti_classical(int nsteps,int nsamples,Eigen::VectorXd & Xinit, Eigen::MatrixXd const & COV_init,std::default_random_engine & generator);
