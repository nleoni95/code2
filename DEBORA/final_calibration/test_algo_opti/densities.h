...
class Density
{
    ...
    double KDE(Eigen::VectorXd const & theta, Eigen::VectorXd const & window) const;
    Eigen::VectorXd GetKDEWindow() const;
    int max_ll() const;
    ...
    int optroutine_nograd(nlopt::vfunc optfunc,void *data_ptr, Eigen::VectorXd &x, Eigen::VectorXd const & lb_hpars, Eigen::VectorXd const & ub_hpars, double max_time)const;
...
class DensityOpt : public Density{
    ...
    double compute_evidence(int npoints, std::default_random_engine & generator) const;
    void Test_hGPs(int npoints, double max_time);
    Eigen::VectorXd Test_hGPs_on_sample(std::vector<Eigen::VectorXd> const & theta_ref,std::vector<Eigen::VectorXd> const & hpars_ref,std::string const & filename) const;
    ...
    void update_hGPs_noPCA(std::vector<Eigen::VectorXd> const &new_thetas,double (*Kernel_GP)(Eigen::VectorXd const &, Eigen::VectorXd const &, Eigen::VectorXd const &),Eigen::MatrixXd const & Bounds_hpars_GPs,Eigen::VectorXd const & Hpars_guess_GPs, double max_time);

    void update_hGPs(std::vector<Eigen::VectorXd> const &new_thetas,std::vector<Eigen::VectorXd> const &new_hpars,double (*Kernel_GP)(Eigen::VectorXd const &, Eigen::VectorXd const &, Eigen::VectorXd const &),Eigen::MatrixXd const & Bounds_hpars_GPs,Eigen::VectorXd const & Hpars_guess_GPs,int nmodes);
...
class Densities{
    ...
    void WritePredictionsF(Eigen::VectorXd const &X,std::string const & filename, int ind_max_ll);
