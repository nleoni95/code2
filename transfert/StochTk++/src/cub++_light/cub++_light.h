...
public:
	...
	RULEQUAD(){ nl = 9; Npt = VectorXi(nl); Npn = VectorXi(nl); prep_fejer();};
	~RULEQUAD(){};
private :
	void prep_fejer();
};
...
public:
	...
	int GetNQ() const { return p_act.size();};
	Type Integrate(); 
