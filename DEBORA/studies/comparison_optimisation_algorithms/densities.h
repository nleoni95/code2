...
class DensityOpt : public Density{
    ...
    Eigen::VectorXd HparsOpt_nograd(Eigen::VectorXd const & theta, Eigen::VectorXd const & hpars_guess,double max_time)const;

    Eigen::VectorXd HparsOpt(Eigen::VectorXd const & theta, Eigen::VectorXd const & hpars_guess,double max_time, int &nevals)const;
    Eigen::VectorXd HparsOpt_nograd(Eigen::VectorXd const & theta, Eigen::VectorXd const & hpars_guess,double max_time, int &nevals)const;
    ...
    Eigen::VectorXd compute_hess_finite_diff(Eigen::VectorXd const & theta, Eigen::VectorXd const & hpars, double pct_distance) const;
    ...
    Eigen::VectorXd derivatives(Eigen::VectorXd const & theta, Eigen::VectorXd const & hpars) const;
    Eigen::VectorXd secondderivatives(Eigen::VectorXd const & theta, Eigen::VectorXd const & hpars) const;
